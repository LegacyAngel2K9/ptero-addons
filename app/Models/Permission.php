...
class Permission extends Model
{
    ...
    protected static $permissions = [
        ...
        'mcmods' => [
            'description' => 'This part is for mcmods addon',
            'keys' => [
                'acces' => 'Allow to user to acces to the mcmods page',
            ],
        ], 
		
        'artifacts' => [
            'description' => 'This part is about the artifact tab (FiveM only). ',
            'keys' => [
                'install' => 'Allows the user to change the server artifact (FiveM only).',
            ],
        ],   
        'backup' => [
