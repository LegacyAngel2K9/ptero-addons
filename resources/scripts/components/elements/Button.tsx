...
interface Props {
    ...
    color?: 'green' | 'red' | 'primary' | 'grey' | 'orange' | 'yellow';
    isSecondary?: boolean;
}
...
const ButtonStyle = styled.button<Omit<Props, 'isLoading'>>`
    ...
    ${props => props.color === 'orange' && css<Props>`
    ${tw`border-yellow-600 bg-yellow-700 text-yellow-50`};
    ...
    ${props => props.isSecondary && css`
        &:active:not(:disabled) {
            ${tw`bg-yellow-800 border-yellow-900`};
        }
    `};
`};
