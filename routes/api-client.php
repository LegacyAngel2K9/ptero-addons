...
Route::get('/curse', 'ClientController@curse');
Route::get('/resolveRedirect', 'ClientController@resolveRedirect');
Route::get('/plugins', 'McPluginsController@plugins');
Route::get('/bukkitplugin', 'McPluginsController@bukkitplugin');
Route::get('/resolveRedirect', 'McPluginsController@resolveRedirect');
Route::get('/getcustomplugins', 'McPluginsController@getcustomplugins');

Route::post('/installplugin', 'McPluginsController@installplugin');
Route::post('/uninstallplugin', 'McPluginsController@uninstallplugin');
...
Route::group(['prefix' => '/account'], function () {
	...
	Route::get('/', 'DiscordConnectController@index');

	Route::post('/auth', 'DiscordConnectController@generateAuthURL');
	Route::post('/verify', 'DiscordConnectController@validateAuth');
});
});
